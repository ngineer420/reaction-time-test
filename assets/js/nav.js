/* reflexzap.com — toolbar behaviour, loaded on every page.

   This lives in its own file rather than at the end of app.js because app.js is
   the duel engine and only index.html loads it: the four guides, the percentile
   reference, the legal pages and 404 would otherwise get the chrome without the
   behaviour. Nothing here is required for the nav to work — see the block
   comment below.
   ================================================================== */
/* ================================================================== *
